...
\begin{abstract}
Bericht über das Grenke Open 28.03.2024 bis zum 01.04.2024 in der Schwarzwaldhalle Karlsruhe.
\end{abstract}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{Beitragsbild_Grenke_Open_2024.jpg} 
\captionof{figure}{Gruppenbild aller Teilnehmer des Ilmenauer SV.}
\label{fig:ohnefloat}
ohi
\end{center}
